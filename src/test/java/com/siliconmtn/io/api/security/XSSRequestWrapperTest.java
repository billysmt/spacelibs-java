...
class XSSRequestWrapperTest {
    ...
    void testStripJson() throws Exception {
        String val =
                "{'com.smt.ezform.person.permission.EzformPermissionController.updateEzformPerson':'ezformUserParser','com.smt.ezform.response.ResponseController.submitResponse':'questionResponseParser'}";
