...
class SecurityAuthorizationExceptionTest {
    ...
    void testSecurityAuthorizationExceptionThrowable() {
        SecurityAuthorizationException sae =
                new SecurityAuthorizationException(new Throwable("Test"));
        assertNotNull(sae);
    ...
    void testSecurityAuthorizationExceptionStringThrowable() {
        SecurityAuthorizationException sae =
                new SecurityAuthorizationException("Another Test", new Throwable("Test"));
        assertNotNull(sae);
        assertEquals("Test", sae.getCause().getMessage());
