...
class ValidateAopTest {
    ...
    void testBeforeAdvice() throws Exception {
        ...
        when(pFact.parserDispatcher(ArgumentMatchers.any(), ArgumentMatchers.any()))
                .thenReturn(null);
    ...
    void testBeforeAdviceErrorParser() throws Exception {
        ...
        when(signature.getMethod()).thenReturn(myMethod);
        when(pFact.parserDispatcher(ArgumentMatchers.any(), ArgumentMatchers.any()))
                .thenReturn(new MyTestParserError());
    ...
    void testBeforeAdviceErrorParserRequest() throws Exception {
        ...
        when(signature.getMethod()).thenReturn(myMethod);
        when(pFact.parserDispatcher(ArgumentMatchers.any(), ArgumentMatchers.any()))
                .thenReturn(new MyTestParserThrow());
 ...
 */
class MyTestParser extends AbstractParser {
    /* Nothing to do */
}
...
class MyTestParserThrow extends AbstractParser {
    public List<ValidationDTO> requestParser(Object obj) throws IOException {
