...
class ClassUtilTest {
    ...
    private class AnnotatedClass {
        @FieldAnnotation private int field;
    ...
    void testGetFieldsByAnnotation() throws Exception {
        var fieldList =
                ClassUtil.getFieldsByAnnotation(AnnotatedClass.class, FieldAnnotation.class);
    ...
    void testGetMethodsByAnnotation() throws Exception {
        var methodList =
                ClassUtil.getMethodsByAnnotation(AnnotatedClass.class, MethodAnnotation.class);
