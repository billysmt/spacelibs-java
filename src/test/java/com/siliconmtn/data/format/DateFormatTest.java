...
class DateFormatTest {
    ...
    void ZoneDateToDateTest() throws ParseException {
        ZonedDateTime dateTime5 =
                ZonedDateTime.of(
                        LocalDateTime.of(2021, 01, 22, 07, 00), ZoneId.of("America/Denver"));
        assertEquals(
                "Fri Jan 22 07:00:00 MST 2021", DateFormat.zoneDateToDate(dateTime5).toString());
    }
    ...
    void formatDateTest() {
        ...
        assertEquals(
                "Sat Oct 28 00:00:00 MDT 1995",
                DateFormat.formatDate(DatePattern.DATE_SLASH, "10/28/1995").toString());
        assertEquals(
                "Thu Feb 04 16:57:00 MST 2021",
                DateFormat.formatDate(DatePattern.ISO_SHORT, "2021-02-04T16:57:00.000Z")
                        .toString());
    }
    ...
    void formatTimestampTest() {
        ...
        java.sql.Timestamp ts =
                java.sql.Timestamp.valueOf(java.time.LocalDate.of(1995, 10, 28).atStartOfDay());
    ...
    void getCurrentTest() {
        ...
        assertEquals(
                Calendar.getInstance().get(Calendar.DAY_OF_WEEK), DateFormat.getCurrentDayOfWeek());
        assertEquals(
                Calendar.getInstance().get(Calendar.DAY_OF_MONTH),
                DateFormat.getCurrentDayOfMonth());
    ...
    void anyZoneToUTCTest() {
        ...
        ZonedDateTime then = DateFormat.anyZoneToUTC(d, TimeZone.getDefault().getID());
        ZonedDateTime then2 = DateFormat.anyZoneToUTC("10/29/1995", TimeZone.getDefault().getID());
