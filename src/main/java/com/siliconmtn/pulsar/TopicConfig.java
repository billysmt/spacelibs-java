...
public class TopicConfig {
    ...
    public String getUniqueSubscriptionName() {
        return String.format(
                "%s-%s", subscriptionName, UUID.randomUUID().toString().replace("-", ""));
    }
    ...
    public String getSiloedTopic(String silo, String separator) {
        ...
        if (!StringUtils.isEmpty(silo)) {
            topic.append(StringUtil.defaultString(separator, DEFAULT_SEPARATOR))
                    .append(StringUtil.defaultString(silo));
        }
