...
public class EntityUtil {
        ...
        try {
            ...
            for (Field dtoField : fields) {
                ...
                if (Modifier.isFinal(dtoField.getModifiers())
                        || dtoField.getDeclaredAnnotation(EntityIgnore.class) != null) continue;
            ...
            for (Field dtoField : dto.getDeclaredFields()) {
                ...
                if (entityField.getType() != dtoField.getType() && value != null) {
                    List<Field> fieldsWithId =
                            ClassUtil.getFieldsByAnnotation(entityField.getType(), Id.class);
    ...
    private Object getValueFromInstance(String fieldName, Object classInstance)
        ...
        return new PropertyDescriptor(fieldName, classInstance.getClass())
                .getReadMethod()
    ...
    private void setValueIntoInstance(String fieldName, Object classInstance, Object valueToSet)
            throws IllegalAccessException, InvocationTargetException, IntrospectionException {
        new PropertyDescriptor(fieldName, classInstance.getClass())
                .getWriteMethod()
                .invoke(classInstance, valueToSet);
    }
}
