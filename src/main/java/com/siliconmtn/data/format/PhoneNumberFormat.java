...
public class PhoneNumberFormat implements Serializable {
    ...
    private static final PhoneNumberUtil.PhoneNumberFormat INTL_FORMAT =
            PhoneNumberUtil.PhoneNumberFormat.INTERNATIONAL;
    private static final PhoneNumberUtil.PhoneNumberFormat NTNAL_FORMAT =
    ...
    String assignUSFormatting(char startDelim, char endDelim) {
        if (StringUtil.isEmpty(formattedNumber) || formattedNumber.length() < 7)
